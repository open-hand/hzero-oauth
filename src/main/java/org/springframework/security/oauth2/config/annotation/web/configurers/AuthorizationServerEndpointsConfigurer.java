 ...
 *
 * @author bojiangzhou add AuthorizeSuccessProcessor;
 * @author Rob Winch
 * @author Dave Syer
 * @since 2.0
 */
public final class AuthorizationServerEndpointsConfigurer {
	 ...
	 */
	public AuthorizationServerEndpointsConfigurer setClientDetailsService(ClientDetailsService clientDetailsService) {
    ...
    public AuthorizationServerEndpointsConfigurer setAuthorizeSuccessProcessors(List<AuthorizeSuccessProcessor> authorizeSuccessProcessors) {
        if (!CollectionUtils.isEmpty(authorizeSuccessProcessors)) {
    ...
    public List<AuthorizeSuccessProcessor> getAuthorizeSuccessProcessors() {
        return authorizeSuccessProcessors;
    }
